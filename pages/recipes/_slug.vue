  ...
  <div>
    ...
    <section class="body-container">
      <main class="wrapper">
        ...
        <div class="copy">
          <vue-markdown>{{ingredients}}</vue-markdown>
          <vue-markdown>{{method}}</vue-markdown>
        </div>
      </main>
    </section>
  ...
  asyncData ({ env, params }) {
    return client.getEntries({
      ...
      return {
        ...
        ingredients: documentToHtmlString(entries.items[0].fields.ingredients),
        method: documentToHtmlString(entries.items[0].fields.method)
      }
    })
    .catch(console.error)
  },
